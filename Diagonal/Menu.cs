...
namespace Matrix
{
    public class Menu
    {
        private List<ChessboardMatrix> vec = new List<ChessboardMatrix>();
        ...
        private void SetElement()
        {
            ...
            do
            {
                ...
                catch (ChessboardMatrix.ReferenceToNullPartException)
                {
        ...
        private void Sum()
        {
            ...
            catch (ChessboardMatrix.DifferentSizeException)
            {
